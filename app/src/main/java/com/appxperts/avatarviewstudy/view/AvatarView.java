 ...
 */
package com.appxperts.avatarviewstudy.view;
...
import com.appxperts.avatarviewstudy.R;
import com.appxperts.avatarviewstudy.outlineprovider.RoundOutlineProvider;
...
public class AvatarView extends ImageView implements Checkable {
    ...
    protected void onDraw(@NonNull Canvas canvas) {
        ...
        if (mChecked) {
            ...
            Drawable border = getResources().getDrawable(R.drawable.ic_check, null);
            border.setBounds(0, 0, getWidth(), getHeight());
